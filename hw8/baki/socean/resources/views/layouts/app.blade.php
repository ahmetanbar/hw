        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm p-3">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <strong>socean |</strong> <p class="d-inline text-muted" style="font-weight: lighter">social ocean</p>
                </a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <div>
                                        <a class="dropdown-item text-primary" href="/profile/{{Auth::user()->id}}/edit">Edit Profile</a>
                                    </div>
